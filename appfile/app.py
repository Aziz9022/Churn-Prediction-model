...
model = pickle.load(open('C:/Users/kanoo/OneDrive/Desktop/customer churn/github churn/Customer_churn_prediction/xgboost_model.pkl', 'rb'))
model.save_model('xgboost_model.json')

model = xgb.Booster.save_model()
